...
const RecipeCard = ({recipe,bg,badge}) => {
  ...
  return (
    ...
    <a href={`https://www.youtube.com/results?search_query=${recipe.label} recipe`}target='_blank' className='relative h-32'>
      <img src={recipe.image} alt="image" className='rounded-md w-full h-full object-cover cursor-pointer'/>
      <div className="absolute bottom-2 left-2 bg-white rounded-full p-1 cursor-pointer gap-1 text-sm flex items-center">
